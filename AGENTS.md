...
- Stock global bundles must not enable project-pinned toolchains (`nodejs`, `go`, `bun`, `terraform`, `opentofu`); keep those in project templates/devShells unless a host explicitly opts in.
