...
usage() {
  cat <<'USAGE'
Usage:
  scripts/vscode-instances.sh bootstrap --name <name> --base-dir <path> --code-bin <path> --settings-json <path> --extensions-txt <path> --baseline-id <id>
  scripts/vscode-instances.sh launch --name <name> --base-dir <path> --code-bin <path> --settings-json <path> --extensions-txt <path> --disabled-extensions-txt <path> --baseline-id <id> [-- <code args...>]
  scripts/vscode-instances.sh reset --name <name> --base-dir <path> --code-bin <path> --settings-json <path> --extensions-txt <path> --baseline-id <id>
USAGE
}
