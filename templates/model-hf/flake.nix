{
  description = "Hugging Face / large model artifact repository template";
  ...
  outputs = inputs @ { flake-parts, treefmt-nix, git-hooks-nix, ... }:
    ...
    if unsafeFlakeSource then
      ...
      perSystem = { pkgs, config, ... }: {
        ...
        treefmt = { projectRootFile = "flake.nix"; programs = { nixpkgs-fmt.enable = true; ruff-format.enable = true; shfmt.enable = true; taplo.enable = true; }; };
